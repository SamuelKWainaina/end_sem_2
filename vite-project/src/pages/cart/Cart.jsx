...
function Cart() {
  ...
  const handlePaymentSuccess = (orderId) => {
    ...
    const orderInfo = {
      ...
      paymentId: orderId, // assuming you get the PayPal order ID here
    };
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          >
            ...
            <PayPalButton
              ...
              options={{
                clientId: 'AY4glB9bZ_t5gx1qFuke2scu-6vGVHwM3wO-4tTmVxHKKDE2_A7Ah-Gz_DRdY-hjp86x4b6djjXM1_jX', // Replace with your PayPal client ID
              }}
            />
          </div>
        </div>
